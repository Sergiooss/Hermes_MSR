...
def generate_launch_description():
    ...
    pkg_share_folder = get_package_share_directory('hermes_description')
    ...
    joint_state_broadcaster = GroupAction([
        generate_load_controller_launch_description(
            ...
            controller_params_file=join(
                pkg_share_folder, 'config', 'hermes_controllers.yaml')
        ),
    ])
    ...
    base_controller = GroupAction([
        generate_load_controller_launch_description(
            controller_name='hermes_base_control',
            controller_params_file=join(
                pkg_share_folder, 'config', 'hermes_controllers.yaml')
        )
    ])

    arm_pkg_share_folder = get_package_share_directory('hermes_moveit_config')
